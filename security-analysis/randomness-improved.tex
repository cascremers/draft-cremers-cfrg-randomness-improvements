...
\begin{itemize}
	...
	\item We say that the $i$th \texttt{output} query is \emph{fresh} if one of the values $y_i$ and $\mathrm{\texttt{signature}}$ stay secret. That is, if one of the following conditions is satisfied:
	\begin{itemize}
